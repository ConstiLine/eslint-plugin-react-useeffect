...
module.exports = {
    ...
    create(context) {
        ...
        function isInTopLevelEffectFunction(node) {
            ...
            return ancestors.find((ancestor) => (ancestor.type === 'FunctionExpression' || ancestor.type === 'ArrowFunctionExpression') && effectFunctions.has(ancestor));
        }
        ...
        return {
            ...
            ReturnStatement(node) {
                const nearestFn = getAncestors(node).find(n =>
